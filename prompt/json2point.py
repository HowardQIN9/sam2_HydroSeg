...
def label_studio_to_sam(json_path, output_json):
    """
    Convert Label Studio keypoints JSON to SAM point prompts.
    ...
    for task in data:
        ...
        # Remove any prefix before "image_" (e.g., "07069557-image_20241112_130006.jpg" → "image_20241112_130006.jpg")
        if "-" in img_basename:
    ...
    with open(output_json, "w", encoding="utf-8") as fp:
        json.dump(sam_points, fp, indent=2, ensure_ascii=False)
